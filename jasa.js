      ...
      <div class="modal-body">
        <form action="" method="POST">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
             viewBox="0 0 512 512" width="24" height="24" class="form-icon" fill="#28a745">
            ...
            <input type="text" class="form-control" name="nama-jasa" id="nama-jasa" placeholder="contoh: Print Dokumen" required />
          </div>
          <!-- lama jasa -->
          <div class="form-group position-relative">
            ...
            <input name="lama-jasa" class="form-control" id="lama-jasa" placeholder="contoh : 3" required />
          </div>
          <!-- harga jasa -->
          <div class="form-group position-relative">
            ...
            <input type="number" class="form-control" name="harga-jasa" id="harga-jasa" placeholder="contoh: 10000" required />
          </div>
          <!-- tombol tambah -->
